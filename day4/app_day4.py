...
@st.cache
def load_data():
    df_agg = pd.read_csv("../assets/datasets/Aggregated_Metrics_By_Video.csv").iloc[1:,:]
    ...
    df_agg_sub = pd.read_csv("../assets/datasets/Aggregated_Metrics_By_Country_And_Subscriber_Status.csv").iloc[1:,:]
    df_comments = pd.read_csv("../assets/datasets/All_Comments_Final.csv").iloc[1:,:]
    df_time = pd.read_csv("../assets/datasets/Video_Performance_Over_Time.csv").iloc[1:,:]
